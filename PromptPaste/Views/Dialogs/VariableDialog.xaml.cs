...
public partial class VariableDialog : Window
{
    ...
    public VariableDialog(List<string> variables)
    {
        ...
        var labelStyle = (Style)FindResource("VariableLabelStyle");
        var textBoxStyle = (Style)FindResource("VariableTextBoxStyle");

        foreach (var v in variables)
        {
            var label = new TextBlock { Text = v, Style = labelStyle };
            var box = new TextBox { Style = textBoxStyle };
